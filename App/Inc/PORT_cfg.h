...
//      模块通道    端口          可选范围                          建议
#define UART0_RX_PIN    PTB16        //PTA1、PTA15、PTB16、PTD6          PTA1不要用（与Jtag冲突）
#define UART0_TX_PIN    PTB17        //PTA2、PTA14、PTB17、PTD7          PTA2不要用（与Jtag冲突）
...
#define SPI0_PCS0_PIN   PTD0        // PTA14、PTC4、PTD0、        全部都是 ALT2
